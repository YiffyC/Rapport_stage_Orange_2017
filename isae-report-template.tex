...
En premier lieu, j'adresse mes remerciements à mon professeur, Mme.~Sandrine \textsc{Lanquetin} de l'Université de Bourgogne qui m'a permis de postuler dans cette entreprise.\\

Je remercie également toute l'équipe de la SDFY Orange pour leur accueil et leur esprit d'équipe.\\

Je tiens à adresser toute ma gratitude à mon tuteur, Mr.~Olivier \textsc{Leick}, responsable solution au sein d' Orange, pour son accueil, ses conseils, le temps passé ensemble et le partage de son expertise au quotidien ainsi que ses précieux conseils lors de la rédaction de ce rapport.\\

Enfin, ces remerciements seraient incomplets si je n'en adressaient pas aux personnes qui m'ont relu et corrigé : mes parents Isabelle et Pascal \textsc{Thévenet}, ma compagne Mélanie \textsc{Theveneau} et mes amis Noémie \textsc{Vial} et Thomas \textsc{Herrmann}.\\
